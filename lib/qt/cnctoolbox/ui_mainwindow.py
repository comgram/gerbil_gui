...
"#lcdNumber_mz { color: #ab1111; }")
        ...
        self.gridLayout.addLayout(self.verticalLayout_2, 13, 13, 1, 4)
        ...
        self.gridLayout.addLayout(self.gridLayout_4, 10, 1, 2, 2)
        ...
        self.gridLayout.addWidget(self.horizontalSlider_feed_override, 13, 0, 1, 3)
        ...
        self.gridLayout.addLayout(self.horizontalLayout_3, 12, 0, 1, 3)
        ...
        self.gridLayout.addLayout(self.gridLayout_11, 0, 11, 14, 1)
        ...
        self.gridLayout.addLayout(self.verticalLayout_cmd, 12, 13, 1, 4)
        ...
        self.gridLayout.addLayout(self.gridLayout_3, 10, 0, 2, 1)
        ...
        self.gridLayout.addLayout(self.verticalLayout_xyz, 0, 0, 10, 1)
        ...
        self.gridLayout.addWidget(self.comboBox_coordinate_systems, 9, 1, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_current_cs_setzero, 9, 2, 1, 1)
        ...
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 285, 136))
        font = QtGui.QFont()
        font.setFamily("DejaVu Sans Mono")
        font.setPointSize(9)
        ...
        self.gridLayout.addWidget(self.pushButton_job_halt, 3, 15, 1, 1)
        ...
        self.gridLayout.addWidget(self.pushButton_job_run, 3, 14, 1, 1)
        ...
        self.gridLayout.addWidget(self.label_current_gcode, 2, 13, 1, 3)
        ...
        self.gridLayout.addWidget(self.listWidget_logoutput, 10, 13, 2, 4)
